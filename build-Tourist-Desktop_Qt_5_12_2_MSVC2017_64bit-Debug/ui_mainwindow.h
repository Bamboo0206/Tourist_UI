...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pic_lb->setObjectName(QString::fromUtf8("pic_lb"));
        pic_lb->setGeometry(QRect(20, 20, 1021, 811));
        pic_lb->setStyleSheet(QString::fromUtf8(""));
        ...
        SysTime_lb->setObjectName(QString::fromUtf8("SysTime_lb"));
        SysTime_lb->setGeometry(QRect(1160, 110, 72, 15));
        allUser_lb = new QLabel(centralWidget);
        allUser_lb->setObjectName(QString::fromUtf8("allUser_lb"));
        allUser_lb->setGeometry(QRect(1070, 150, 72, 15));
        allUser_tb = new QTableWidget(centralWidget);
        allUser_tb->setObjectName(QString::fromUtf8("allUser_tb"));
        allUser_tb->setGeometry(QRect(1060, 190, 501, 291));
        ...
        exitSys_btn->setObjectName(QString::fromUtf8("exitSys_btn"));
