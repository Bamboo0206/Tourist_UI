...
public:
    ...
    void setupUi(QDialog *ChangeUserInfoDlg)
    {
        if (ChangeUserInfoDlg->objectName().isEmpty())
            ChangeUserInfoDlg->setObjectName(QString::fromUtf8("ChangeUserInfoDlg"));
        ...
        compute_btn->setObjectName(QString::fromUtf8("compute_btn"));
        ...
        src_lb->setObjectName(QString::fromUtf8("src_lb"));
